 ...
 * @author Chingo
 */
class AWEPlacement<T extends Options> extends AbstractAWEPlacement<T, IPlacement> {
     ...
     * @param callback
     */
    AWEPlacement(PlayerEntry playerEntry, IPlacement placement, UUID taskUUID, IAWECallback callback) {
