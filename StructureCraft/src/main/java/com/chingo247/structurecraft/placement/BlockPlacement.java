...
import com.chingo247.structurecraft.construction.StructureBlock;
 ...
 * @author Chingo
 */
public abstract class BlockPlacement<T extends Options> extends AbstractPlacement<T> implements IBlockPlacement<T> {
    ...
    @Override
    public void place(EditSession editSession, Vector pos, T option) {
