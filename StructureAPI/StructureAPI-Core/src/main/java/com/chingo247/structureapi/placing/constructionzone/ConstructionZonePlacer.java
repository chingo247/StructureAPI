...
//import com.chingo247.structureapi.placing.OwnerDomain;
...
// * @author Chingo
// */
//public class ConstructionZonePlacer extends OwnerDomain<ConstructionZonePlacer>  {
//    
...
//    }
//
//    public ConstructionZonePlacer setAccess(AccessType accessType) {
//        Preconditions.checkNotNull(accessType, "AccessType may not be null");
//        this.accessType = accessType;
//        return this;
//    }
//
//    public ConstructionZonePlaceResult place(CuboidRegion region) {
...
//                
//                
//                ConstructionZoneRepository constructionZoneRepository = new ConstructionZoneRepository(graph);
//                // Check overlap
...
//                
//                // Add zone to world
//                StructureWorldRepository structureWorldRepository = new StructureWorldRepository(graph);
...
//            StructureAPI.getInstance().getEventDispatcher().dispatchEvent(new ConstructionZoneCreateEvent(placeResult.getPlaced()));
//        }
//        
//        
//        return placeResult;
